...
* The original package name 'com.db.db-world' is invalid and this project uses 'com.db.dbworld' instead.
...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.1.5-SNAPSHOT/reference/htmlsingle/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/3.1.5-SNAPSHOT/reference/htmlsingle/index.html#data.nosql.mongodb)
