...
export default function MainPage() {
  ...
  const tilesConfig = useMemo(() => [
    { title: "Newly Added", requestUrl: requests.fetchAllMovies, horizontal: true },
    { title: "Bollywood", requestUrl: requests.fetchBollywoodMovies },
    { title: "Hollywood", requestUrl: requests.fetchHollywoodMovies },
    { title: "South", requestUrl: requests.fetchSouthMovies },
    { title: "Gujarati", requestUrl: requests.fetchGujaratiMovies },
    { title: "K-Drama", requestUrl: requests.fetchKoreanMovies }
  ], []);
