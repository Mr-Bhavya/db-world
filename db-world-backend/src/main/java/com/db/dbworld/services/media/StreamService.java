...
public interface StreamService {
     ...
     */
    ResponseEntity<Void> streamByPath(
            String user,
            Path path,
            String rangeHeader,
            boolean inline
     ...
     */
    ResponseEntity<Void> streamById(
            String user,
            String mediaFileId,
            String rangeHeader,
            boolean inline
    ...
    List<MediaFileInfo> getMediaInfoByFileId(String fileId);

    /**
     * Parse MediaInfo JSON output into structured objects.
     */
