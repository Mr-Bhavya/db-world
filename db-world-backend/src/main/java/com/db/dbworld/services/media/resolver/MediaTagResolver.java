...
public final class MediaTagResolver {
    ...
    public static final Map<String, String> LANGUAGE_MAP = Map.<String, String>ofEntries(
            ...
            Map.entry("kannada", "Kannada"),

            // --------------------
            // Punjabi
            // --------------------
            Map.entry("pa", "Punjabi"),
            Map.entry("pan", "Punjabi"),
            Map.entry("punjabi", "Punjabi"),
            ...
            Map.entry("asm", "Assamese"),
            Map.entry("assamese", "Assamese"),

            // --------------------
            // Kashmiri
            // --------------------
            Map.entry("ks", "Kashmiri"),
            Map.entry("kas", "Kashmiri"),
            Map.entry("kashmiri", "Kashmiri"),

            // --------------------
            // Nepali
            // --------------------
            Map.entry("ne", "Nepali"),
            Map.entry("nep", "Nepali"),
            Map.entry("nepali", "Nepali"),
            ...
            // --------------------
            Map.entry("sd", "Sindhi"),
            Map.entry("snd", "Sindhi"),
            Map.entry("sindhi", "Sindhi"),

            // --------------------
            // Konkani
            // --------------------
            Map.entry("kok", "Konkani"),
            Map.entry("konkani", "Konkani"),
            ...
            Map.entry("maithili", "Maithili"),

            // --------------------
            // Santhali
            // --------------------
            Map.entry("sat", "Santhali"),
            Map.entry("santhali", "Santhali"),

            // =========================================================
            // GLOBAL CINEMA LANGUAGES
            // =========================================================
            ...
            Map.entry("fas", "Persian"),
            Map.entry("persian", "Persian"),

            Map.entry("he", "Hebrew"),
            Map.entry("heb", "Hebrew"),
            Map.entry("hebrew", "Hebrew"),
            ...
            Map.entry("mul", "Multiple"),
            Map.entry("multi", "Multiple"),
            Map.entry("various", "Multiple"),

            Map.entry("und", "Unknown"),
            Map.entry("unknown", "Unknown"),
            Map.entry("n/a", "Unknown"),
            Map.entry("", "Unknown")
    );
    ...
    public static String resolveHdr(String raw) {
        return resolve(raw, HDR_REVERSE);
    }

    public static String resolveVideoCodec(String raw) {
        return resolve(raw, CODEC_REVERSE);
    }

    public static String resolveAudioCodec(String raw) {
        return resolve(raw, AUDIO_CODEC_REVERSE);
    }
