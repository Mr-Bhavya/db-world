 ...
 * {@link SplitExpensePayerEntity} — there can be more than one — and who consumed it lives in
 * {@link SplitExpenseShareEntity}. Those two together are the source of truth; the ledger is a
 ...
 */
@Entity
@Table(name = "split_expense", schema = "db_world",
        uniqueConstraints = {
            ...
            @UniqueConstraint(name = "uk_split_expense_group_idem",
        ...
        indexes = {
            ...
            @Index(name = "idx_split_expense_group_date",
...
public class SplitExpenseEntity {
    ...
    private SplitExpenseStatus status = SplitExpenseStatus.ACTIVE;

    /** Client-supplied retry token; see {@code uk_split_expense_group_idem}. */
    ...
    public boolean isActive() {
        return status == SplitExpenseStatus.ACTIVE;
    }
}
