package com.db.dbworld.app.split.dto;

import com.db.dbworld.app.split.entity.SplitMethod;
...
public record CreateExpenseRequest(
     ...
     * the expense's {@link SplitMethod}; the others are ignored rather than rejected, so a
