 ...
 */
@Entity
@Table(name = "split_settlement", schema = "db_world",
        uniqueConstraints = {
            ...
            @UniqueConstraint(name = "uk_split_settlement_group_idem",
                    columnNames = {"group_id", "idempotency_key"})
        },
        indexes = {
            @Index(name = "idx_split_settlement_group_date",
                    columnList = "group_id, settled_at")
        })
@Getter @Setter @NoArgsConstructor
public class SplitSettlementEntity {
    ...
    private SplitSettlementStatus status = SplitSettlementStatus.ACTIVE;
    ...
    public boolean isActive() {
        return status == SplitSettlementStatus.ACTIVE;
    }
}
