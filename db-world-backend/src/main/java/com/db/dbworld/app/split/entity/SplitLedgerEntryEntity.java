 ...
 *       {@link SplitLedgerEntryType#REVERSAL}, which is <b>the same edge with from and to
 ...
 */
@Entity
@Table(name = "split_ledger_entry", schema = "db_world",
        indexes = {
            ...
            @Index(name = "idx_split_ledger_entry_group_to",
                    columnList = "group_id, to_member_id, amount"),
            @Index(name = "idx_split_ledger_entry_group_from",
            ...
            @Index(name = "idx_split_ledger_entry_source",
                    columnList = "source_type, source_id")
        })
@Getter @Setter @NoArgsConstructor
public class SplitLedgerEntryEntity {
    ...
    private SplitLedgerSourceType sourceType;
    ...
    private SplitLedgerEntryType entryType = SplitLedgerEntryType.ORIGINAL;
