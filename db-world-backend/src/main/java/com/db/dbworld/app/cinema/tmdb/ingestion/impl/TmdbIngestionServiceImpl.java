...
public class TmdbIngestionServiceImpl implements TmdbIngestionService {
    ...
    private TvSeriesTmdbEntity fetchAndSaveTvSeries(Long tmdbId) {
        ...
        clearAutoGeneratedCollections(tmdbId);
        // Load existing seasons (with episodes) into the L1 cache before merging.
        // This serves two purposes:
        //   1. Prevents orphan-removal from deleting seasons when the entity (which
        //      now has seasons=null from the mapper) is merged.
        //   2. Ensures ingestSeasonsBlocking finds managed entities whose episodes
        //      are Hibernate PersistentBags — not plain ArrayLists — so autoflush
        //      during episode queries doesn't throw "collection no longer referenced".
