 ...
 */
@Entity
@Table(name = "split_expense_payer", schema = "db_world",
        uniqueConstraints = {
            ...
            @UniqueConstraint(name = "uk_split_expense_payer_expense_member",
                    columnNames = {"expense_id", "member_id"})
        },
        indexes = {
            @Index(name = "idx_split_expense_payer_expense", columnList = "expense_id")
        })
@Getter @Setter @NoArgsConstructor
public class SplitExpensePayerEntity {
